...
function chat_palette(source, mode) {
    ...
    const yomi_order = [
        [211, 2220, 2230, 2250, 2330, 451, 711, 1240, 1310, 1320, 1710, 1910],
        [151, 213, 214, 215, 222, 321, 322, 342, 430, 452, 453, 740],
        [130, 221, 323, 324, 331, 341, 350, 422, 441, 510, 640],
        [121, 325, 344, 540, 652],
        [122, 152, 212, 231, 241, 242, 251, 252, 327, 328, 343, 421, 442, 443, 610, 630, 651, 810, 940]
    ];
    // option name
    ...
    skill.forEach((item, index) => {
        try {
            ...
            yomi_order[index] = yomi_order[index].concat(Array(3).fill(index  * 100 + 3000));
        } catch (error) {
